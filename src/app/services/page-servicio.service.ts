...
export class PageServicioService {
  ...
  busquedaServicioManager(termino: string): Observable<ObjetoServicioARealizar[] | null>{
    return this.http.get<ObjetoServicioARealizar[]>(`${this.urlEndPoint}/servicio-a-realizar-manager/${termino}`)
          .pipe(
            catchError(e => {
              console.log(e)
              return throwError(() => e)
  ...
  busquedaServicio(termino: string): Observable<ObjetoServicioARealizar[] | null>{
    return this.http.get<ObjetoServicioARealizar[]>(`${this.urlEndPoint}/servicio-a-realizar-servicio/${termino}`)
          .pipe(
            catchError(e => {
              console.log(e)
              return throwError(() => e)
